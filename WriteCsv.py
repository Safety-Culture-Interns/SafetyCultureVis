...
def write_to_csv(audits):
    csv_data = [["audit_id", "template_id", "archived", "audit_created_at", "audit_modified_at", "score",
                 "total_score", "score_percentage", "audit_name", "duration", "date_completed", "owner_name",
